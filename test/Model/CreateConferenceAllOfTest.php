...
class CreateConferenceAllOfTest extends TestCase
{
    ...
    public function testPropertyActionUrl()
    {
        ...
        $this->assertStringContainsString($this->CreateConferenceAllOf->getActionUrl(), 'TEST_STRING');
    ...
    public function testPropertyAlias()
    {
        ...
        $this->assertEquals($this->CreateConferenceAllOf->getAlias(), true);
    ...
    {
        $this->CreateConferenceAllOf->setPlayBeep('TEST_STRING');
        $this->assertStringContainsString($this->CreateConferenceAllOf->getPlayBeep(), 'TEST_STRING');
        $this->assertIsString($this->CreateConferenceAllOf->getPlayBeep());
    ...
    public function testPropertyRecord()
    {
        ...
        $this->assertEquals($this->CreateConferenceAllOf->getRecord(), true);
    ...
    {
        $this->CreateConferenceAllOf->setStatusCallbackUrl(true);
        $this->assertEquals($this->CreateConferenceAllOf->getStatusCallbackUrl(), true);
        $this->assertIsBool($this->CreateConferenceAllOf->getStatusCallbackUrl());
    }
    /**
    ...
    public function testPropertyWaitUrl()
    {
        ...
        $this->assertStringContainsString($this->CreateConferenceAllOf->getWaitUrl(), 'TEST_STRING');
