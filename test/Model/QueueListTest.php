...
class QueueListTest extends TestCase
{
    ...
    public function testPropertyTotal()
    {
        ...
        $this->assertEquals($this->QueueList->getTotal(), 12345);
    ...
    public function testPropertyStart()
    {
        ...
        $this->assertEquals($this->QueueList->getStart(), 12345);
    ...
    public function testPropertyEnd()
    {
        ...
        $this->assertEquals($this->QueueList->getEnd(), 12345);
    ...
    public function testPropertyPage()
    {
        ...
        $this->assertEquals($this->QueueList->getPage(), 12345);
    ...
    public function testPropertyNumPages()
    {
        ...
        $this->assertEquals($this->QueueList->getNumPages(), 12345);
    ...
    public function testPropertyPageSize()
    {
        ...
        $this->assertEquals($this->QueueList->getPageSize(), 12345);
    ...
    public function testPropertyNextPageUri()
    {
        ...
        $this->assertStringContainsString($this->QueueList->getNextPageUri(), 'TEST_STRING');
    ...
    {
        $this->QueueList->setQueues(array());
