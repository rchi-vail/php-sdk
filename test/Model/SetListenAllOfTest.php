...
class SetListenAllOfTest extends TestCase
{
    ...
    public function testPropertyCallId()
    {
        ...
        $this->assertStringContainsString($this->SetListenAllOf->getCallId(), 'TEST_STRING');
    ...
    {
        $this->SetListenAllOf->setListen(true);
        $this->assertEquals($this->SetListenAllOf->getListen(), true);
