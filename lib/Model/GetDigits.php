...
class GetDigits extends PerclCommand 
{
     ...
     * Sets prompts
     *
     * @param \OpenAPI\Client\Model\PerclCommand[]|null $prompts JSON array of PerCL commands to nest within the `GetDigits` command. The `Say`, `Play`, and `Pause` commands can be used. The nested actions are executed while FreeClimb is waiting for input from the Caller.
     *
     * @return $this
     */
