 ...
 */
class PlayAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets file
     *
     * @param string $file RL of the audio file to be played to the caller. The URL can be the `recordingUrl` generated from the `RecordUtterance` or `StartRecordCall` PerCL commands.
     *
     * @return self
     */
     ...
     * Sets loop
     *
     * @param int|null $loop Number of times the audio file is played. Specifying '0' causes the Play action to loop until the Call is hung up.
     *
     * @return self
     */
