...
/**
 * PerclCommand Class Doc Comment
 *
 * @category Class
 ...
 */
class PerclCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PerclCommand';
     ...
     * Sets command
     *
     * @param string|null $command Name of PerCL Command (this is automatically derived from mapping configuration and should not be manually supplied in any arguments)
     *
     * @return self
     */
