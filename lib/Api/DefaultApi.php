...
class DefaultApi
{
     ...
     * @param  \OpenAPI\Client\Model\BuyIncomingNumberRequest $buy_incoming_number_request Incoming Number transaction details (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \OpenAPI\Client\Model\DequeueMemberRequest $dequeue_member_request Dequeue member request details (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \OpenAPI\Client\Model\DequeueMemberRequest $dequeue_member_request Dequeue head member request details (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\QueueMember
     ...
     * @param  \OpenAPI\Client\Model\FilterLogsRequest $filter_logs_request Filter logs request paramters (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function listSmsMessages($account_id, $to = null, $from = null, $begin_time = null, $end_time = null, $direction = null, $account_id = null)
    {
        list($response) = $this->listSmsMessagesWithHttpInfo($account_id, $to, $from, $begin_time, $end_time, $direction, $account_id);
        return $response;
    }
     ...
     */
    public function listSmsMessagesWithHttpInfo($account_id, $to = null, $from = null, $begin_time = null, $end_time = null, $direction = null, $account_id = null)
    {
        $request = $this->listSmsMessagesRequest($account_id, $to, $from, $begin_time, $end_time, $direction, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSmsMessagesAsync($account_id, $to = null, $from = null, $begin_time = null, $end_time = null, $direction = null, $account_id = null)
    {
        return $this->listSmsMessagesAsyncWithHttpInfo($account_id, $to, $from, $begin_time, $end_time, $direction, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSmsMessagesAsyncWithHttpInfo($account_id, $to = null, $from = null, $begin_time = null, $end_time = null, $direction = null, $account_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\MessagesList';
        $request = $this->listSmsMessagesRequest($account_id, $to, $from, $begin_time, $end_time, $direction, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listSmsMessagesRequest($account_id, $to = null, $from = null, $begin_time = null, $end_time = null, $direction = null, $account_id = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $account_id ID of the account that sent this message. (required)
     * @param  \OpenAPI\Client\Model\MessageRequest $message_request Details to create a message (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\MessageResult
     ...
     * @param  string $account_id ID of the account that created this call. (required)
     * @param  string $call_id String that uniquely identifies this call resource. (required)
     * @param  \OpenAPI\Client\Model\UpdateCallRequest $update_call_request Call details to update (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
